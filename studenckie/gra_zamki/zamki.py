...
class Game:
    ...
    def do_background(self):
        ...
        castle_imgs = [pygame.image.load("zamek_bronze.jpg").convert(), pygame.image.load("zamek_green.jpg").convert(), pygame.image.load("zamek_red.jpg").convert(), pygame.image.load("zamek_violet.jpg").convert()]
