...
add_interface_port avalon_left_sink avalon_left_sink_data data Input BITS
...
add_interface_port avalon_right_sink avalon_right_sink_data data Input BITS
