...
public class Controler
{
    ...
    */
    ...
    /**
    Dokonuje parsowania programu.
    Uruchamia parser ({@link Parser}) tworzacy liste instrukcji.
    */
    public void parse()
    ...
    Kolejno odczytuje instrukcje z listy, pobiera zmienne, wykonuje operacje i zapisuje nowe wartosci do zmiennych.
            ...
            switch(curInstr)
            {
                ...
                case "DIV":
                   ...
                   arg2 = vrs.getValue(instr.it.arg[2]);
                       ...
                       if(arg2 == 0)
                       {
                           throw new ArithmeticError(0, pc);
                       }
                ...
                case "RDINT":
                   vrs.setValue(instr.it.arg[0], iocon.readInt());
                   instr.nextIt(false);
                   break;

                case "RDCHR":
                   vrs.setValue(instr.it.arg[0], iocon.readChar());
                   instr.nextIt(false);
                   break;
