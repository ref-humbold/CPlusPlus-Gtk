...
gui_runner.cmx : gui_runner.ml gui.cmx menu_gui.cmx stat_gui.cmx board_gui.cmx game_gui.cmx
	$(CAMLOPT) $(CAMLFLAGS) $(GRAPHICS) -c gui_runner.ml -o gui_runner.cmx

game.cmx : game.ml board.cmx game_gui.cmx
...
comp_player.cmx : comp_player.ml board.cmx game_gui.cmx
